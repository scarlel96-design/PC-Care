...
```powershell
dotnet run --project tools\SmartPerformanceDoctor.SecurityLab.Cli -c Release -- policy-selfcheck
dotnet run --project tools\SmartPerformanceDoctor.SecurityLab.Cli -c Release -- hardening
dotnet run --project tools\SmartPerformanceDoctor.SecurityLab.Cli -c Release -- av3-gate
